...
public static class MenuMiaoNetOptions
{
    ...
    public static void BuildMenu(TextMenu menu, bool inGame)
    {
        ...
        */
        ...
        TextMenu.Item target = new EnumSlider<FollowerTargetType>(
            Dialog.Get("miaonet_options_player_followers_target"),
            e => Dialog.Get($"miaonet_options_player_followers_target_{e}"),
            settings.PlayerFollowersTarget
        ).Change(v => settings.PlayerFollowersTarget = v);
        ...
        void UpdateOptionsVisibility(RemotePlayerVisibility mode)
        {
            ...
            bool hidden = mode == RemotePlayerVisibility.Hidden;

            target.Visible = distance || hidden;
